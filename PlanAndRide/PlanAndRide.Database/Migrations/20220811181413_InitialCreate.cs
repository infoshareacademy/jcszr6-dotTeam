    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeoCoordinates", x => new { x.Latitude, x.Longitude });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartingPositionLatitude = table.Column<double>(type: "float", nullable: true),
                    StartingPositionLongitude = table.Column<double>(type: "float", nullable: true),
                    DestinationPositionLatitude = table.Column<double>(type: "float", nullable: true),
                    DestinationPositionLongitude = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routes_GeoCoordinates_DestinationPositionLatitude_DestinationPositionLongitude",
                        columns: x => new { x.DestinationPositionLatitude, x.DestinationPositionLongitude },
                        principalTable: "GeoCoordinates",
                        principalColumns: new[] { "Latitude", "Longitude" });
                    table.ForeignKey(
                        name: "FK_Routes_GeoCoordinates_StartingPositionLatitude_StartingPositionLongitude",
                        columns: x => new { x.StartingPositionLatitude, x.StartingPositionLongitude },
                        principalTable: "GeoCoordinates",
                        principalColumns: new[] { "Latitude", "Longitude" });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_DestinationPositionLatitude_DestinationPositionLongitude",
                table: "Routes",
                columns: new[] { "DestinationPositionLatitude", "DestinationPositionLongitude" });

            migrationBuilder.CreateIndex(
                name: "IX_Routes_StartingPositionLatitude_StartingPositionLongitude",
                table: "Routes",
                columns: new[] { "StartingPositionLatitude", "StartingPositionLongitude" });
